...
public class MaintainModeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.maintain_mode);

        serialBtn = findViewById(R.id.button);

        serialBtn.setOnClickListener(new View.OnClickListener(){
            @Override
                public void onClick(View v){
                Intent intent = null;
                intent = new Intent(MaintainModeActivity.this,SerialPort_Test.class);
