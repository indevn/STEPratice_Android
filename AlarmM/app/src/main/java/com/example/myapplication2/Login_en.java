...
public class Login_en extends AppCompatActivity {
...
//            如果是这样就是串口打开失败，会在接受区显示文字
        ...
        identifyBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                if (rc < 0) {
                    helloword.setText("Request Failed");
                }
            }
        });
        loginBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                if(memberID!=0) {
                    Intent intent = null;
                    intent = new Intent(Login_en.this, MainPage_en.class);
                    startActivity(intent);
                }
                else{
                    helloword.setText("Please identify first");
                }
            }
        });
    }
...
//                        如果读出来了的东西
                            ...
                            if(str.equals("ca")){
                                memberID=1;
                                helloword.setText("Hello，Chen");

                            }else if(str.equals("cb")){
                                memberID=2;
                                helloword.setText("Hello, Fang");
                            }
                        }
                    }
                    break;
