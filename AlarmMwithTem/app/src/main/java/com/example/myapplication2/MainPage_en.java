...
public class MainPage_en extends AppCompatActivity {
...
//    static final int TIME_DIALOG_ID = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_page_en);

        Intent intent = new Intent(MainPage_en.this, wake.class);
        pi = PendingIntent.getActivity(MainPage_en.this, 0, intent, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);
//
...
//        Integer minute;
            ...
            public void onClick(View v) {
                ...
                switch (windStatus) {
                    ...
                    case 0:
                        ...
                        windtemText.setText("Temperature：⬛⬜⬜⬜");
                        windStatus++;
                        break;
                    case 1:
    ...
    private void updateDisplay() {
        ...
        switch(windStatus){
            case 1:
                mp = MediaPlayer.create(MainPage_en.this, R.raw.c1);
                mp.start();
                break;
            case 2:
                mp = MediaPlayer.create(MainPage_en.this, R.raw.c2);
                mp.start();
                break;
            case 3:
                mp = MediaPlayer.create(MainPage_en.this, R.raw.c3);
                mp.start();
                break;
            case 4:
                mp = MediaPlayer.create(MainPage_en.this, R.raw.c4);
                mp.start();
                break;
        }
    }
